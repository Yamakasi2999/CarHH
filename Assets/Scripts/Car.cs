...
public class Car : MonoBehaviour
{
    ...
    float speed, speedInput, turnInput, rotationSpeed;
    bool onGround;
    ...
    void PlayerMove()
    {
        ...
        if(keyboard) speedInput = Input.GetAxis("Vertical");
        if (speedInput > 0)
        {
        ...
        if (keyboard) turnInput = Input.GetAxis("Horizontal");
